          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2 relative group">
              ...
              <Input
                ...
                className="h-12 bg-transparent border-2 border-[var(--color-black-border)] focus-visible:border-[var(--color-red-primary)] focus-visible:ring-[var(--color-red-primary)]/20 focus-visible:ring-2 focus-visible:outline-none rounded-xl transition-all group-hover:border-[var(--color-red-border)]"
              />
            </div>
