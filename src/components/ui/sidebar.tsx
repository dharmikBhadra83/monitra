...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // This is only allowed if the cookie is available.
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn("group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-svh w-full overflow-x-hidden", className)}
          ref={ref}
          {...props}
        >
          {children}
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear after:absolute after:inset-y-0 after:left-1/2 after:w-[2px] after:-translate-x-1/2 after:bg-sidebar-border after:opacity-0 after:transition-opacity after:duration-200 hover:after:opacity-100 group-data-[side=left]/sidebar:right-0 group-data-[side=left]/sidebar:left-0 group-data-[side=right]/sidebar:left-0 [&:not(:hover)]:after:delay-500 peer-data-[collapsible=icon]/sidebar-wrapper:peer-data-[side=left]/sidebar:left-full peer-data-[collapsible=icon]/sidebar-wrapper:peer-data-[side=right]/sidebar:right-full",
          ...
          "group-data-[collapsible=icon]/sidebar-wrapper:flex",
          className
        )}
        {...props}
      />
  ...
  ({ className, ...props }, ref) => {
    return (
      <div
        ref={ref}
        data-sidebar="header"
        className={cn("flex h-16 shrink-0 items-center gap-2 border-sidebar-border px-2", className)}
        {...props}
      />
    )
  }
